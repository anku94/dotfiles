...
require("lazy").setup({
  ...
  { 'ojroques/nvim-osc52' },                                            -- replacement for powerline/airline
  { 'nvim-lualine/lualine.nvim',       dependencies = { 'nvim-tree/nvim-web-devicons' } },
  { 'altercation/vim-colors-solarized' }, { 'tanvirtin/monokai.nvim' }, -- A monokai theme for Neovim
  ...
  {'ms-jpq/coq.thirdparty', branch = '3p'}, {'nvim-lua/plenary.nvim'},

  -- For Vim REPL
  { 'Vigemus/iron.nvim' }, -- For pretty file tree
  { 'nvim-tree/nvim-tree.lua' }, { 'nvim-tree/nvim-web-devicons' },

  -- For nvim-surround
  { 'kylechui/nvim-surround' },              -- For indent-lines
  { 'lukas-reineke/indent-blankline.nvim' }, -- For CSVs
  {
    'cameron-wags/rainbow_csv.nvim',
    config = function()
      vim.g.rcsv_colorlinks = {
        'String', 'Comment', 'NONE', 'Conditional', 'PreProc', 'Type',
        'Question', 'CursorLineNr', 'ModeMsg', 'Title'
      }
  ...
  -- Status bar with LSP integration
--   {
